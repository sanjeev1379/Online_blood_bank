...
if(isset($_POST['search'])){
  ...
  echo "Error in query.. <br />";
    ...
    header("Location:results.php?q=$username&blood_group=".$search_blood_group);
  }
}
    ...
    <div class="container" >
      ...
      <div class="navbar-collapse" id="mainNavBar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a id="left" href="search_donor.php?q=<?php echo $username ?>">Search Donor</a></li>
